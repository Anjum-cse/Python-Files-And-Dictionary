...
#5.We have provided the dictionary groceries. You should return a list of its keys,
...
# For example, the number 17573005 should return 3005. Then, use this function to sort the
# list of ids stored in the variable, ids, from lowest to highest.
# Save this sorted list in the variable, sorted_ids. Hint: Remember that only strings
# can be indexed, so conversions may be needed.
...
# lambda and not using a defined function. Save this sorted list in the variable sorted_id.
